...
(function () {
  ...
  /* ---------- Intro splash (index.html only) ----------
     ...
     ("ptimum" / "pus" / "rchitecture") fades in as plain outline letters.
     The dot in the top-right appears last, as a closing punctuation mark,
     before the whole splash fades out to reveal the homepage. Plays once
     per browser tab session and is skippable by click; respects
